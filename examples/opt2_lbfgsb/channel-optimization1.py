...
turbine = BumpTurbine(diameter=20.0, minimum_distance=20., friction=0.25)
...
f_opt = maximize(rf, bounds=[lb, ub], constraints=ineq, method="L-BFGS-B", options={'maxiter': 300})
