...
mesh = prob_params.domain.mesh
V, Q = prob_params.finite_element(mesh)
function_space = MixedFunctionSpace([V, Q])
...
bc = DirichletBC(W.sub(0), Constant((0.0, 0.0)), domain.facet_ids, 3)
