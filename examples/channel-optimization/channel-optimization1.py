...
turbine = BumpTurbine(diameter=20.0, friction=0.25)
...
farm.add_regular_turbine_layout(num_x=4, num_y=4)
...
f_opt = maximize(rf, bounds=[lb, ub], method="L-BFGS-B", options={'maxiter': 300})
