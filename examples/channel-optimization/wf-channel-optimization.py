...
sol_params = CoupledWFSolver.default_parameters()
sol_params.dump_period = 1
solver = CoupledWFSolver(problem, sol_params)
...
functional = WindPowerFunctional(problem)
