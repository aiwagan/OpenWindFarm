...
domain = RectangularDomain(x0=0, y0=0, x1=100, y1=50, nx=40, ny=20)
...
u_expr = Expression(("sin(pi*t/5)*x[1]*(50-x[1])/625 + 1", "0"), t=Constant(0))
bcs.add_bc("u", u_expr, facet_id=1)
bcs.add_bc("p", Constant(0), facet_id=2)
...
prob_params.initial_condition_p = Constant(0)
...
sol_params = IPCSWFSolver.default_parameters()
solver = IPCSWFSolver(problem, sol_params)
